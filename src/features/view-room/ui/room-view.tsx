...
export function RoomView({ room, slug }: RoomViewProps) {
  ...
  // Indices for preloading next and previous images
              ...
              <motion.div variants={{ hidden: { opacity: 0, y: 16 }, show: { opacity: 1, y: 0 } }}>
                ...
                >
                  <AnimatePresence initial={false} custom={direction}>
                    ...
                    >
                      <Image
                        // The main, visible image gets priority to load first
                        priority={true} 
                ...
                {/* PRELOADING IMAGES: These are hidden but trigger next/image to load them */}
                {images.length > 2 && (
